...
const patientSchema = new Schema({
    ...
    conditions: [{ type: mongoose.Types.ObjectId, ref: 'Condition' }],
    surgeries: [{ type: mongoose.Types.ObjectId, ref: 'Surgery' }],
    gynaikologiko: [{ type: mongoose.Types.ObjectId, ref: 'Gynaikologiko' }],
    pregnacies: [{ type: mongoose.Types.ObjectId, ref: 'Maieutiko' }],
